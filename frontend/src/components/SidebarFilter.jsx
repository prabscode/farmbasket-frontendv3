...
const SidebarFilter = ({ onFilterChange }) => {
  ...
  return (
    <div className="relative flex">
      ...
      {/* Collapse button - positioned on the right side */}
      <button
        onClick={toggleCollapse}
        className="absolute -right-3 top-1/2 transform -translate-y-1/2 bg-gray-700 hover:bg-gray-600 p-2 rounded-r-md shadow-md z-10"
      >
        <CollapseIcon />
      </button>
    </div>
